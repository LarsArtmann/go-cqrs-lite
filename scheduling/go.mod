...
require github.com/larsartmann/go-cqrs-lite/testutil/v3 v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/larsartmann/go-cqrs-lite/id/v3 v0.0.0-00010101000000-000000000000 // indirect
