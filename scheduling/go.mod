...
require github.com/larsartmann/go-cqrs-lite/testutil/v3 v3.7.3
...
require (
	...
	github.com/larsartmann/go-cqrs-lite/event/v3 v3.7.3 // indirect
	github.com/larsartmann/go-cqrs-lite/id/v3 v3.7.3 // indirect
