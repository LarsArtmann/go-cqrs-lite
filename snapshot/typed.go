...
// cross-retry, so legacy snapshots written with either standard codec read
...
// art-dupl:accept codec->record conversion mirror of decider.snapshotEncoding (dep-isolated, ADR-0111)
