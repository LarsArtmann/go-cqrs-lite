...
Full table (82 modules, internal notes): [`docs/agents/module-map.md`](docs/agents/module-map.md). Consumer-facing lookup: [`references/modules.md`](.agents/skills/go-cqrs-lite/references/modules.md).
