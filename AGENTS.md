...
| Int. All   | `nix run .#test-integration` (auto-detect best strategy: ephemeral/nspawn/testcontainers/VM) or `nix run .#integration-all` (ephemeral PG + nspawn MySQL) or `nix run .#verify-integration` (integration gate only)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
