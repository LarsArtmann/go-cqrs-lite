...
type FakeStore struct {
	...
	loadFn            func(ref id.StreamRef) ([]event.Event, error)
	loadFromVersionFn func(ref id.StreamRef, version event.Version) ([]event.Event, error)
	loadToVersionFn   func(ref id.StreamRef, maxVersion event.Version) ([]event.Event, error)
	loadToTimestampFn func(ref id.StreamRef, maxTime time.Time) ([]event.Event, error)
	appendBatchFn     func(ref id.StreamRef, events []event.Event) error
	closeFn           func() error
...
func (s *FakeStore) LoadFn(
	fn func(ref id.StreamRef) ([]event.Event, error),
) *FakeStore {
	s.loadFn = fn
...
func (s *FakeStore) LoadFromVersionFn(
	fn func(ref id.StreamRef, version event.Version) ([]event.Event, error),
) *FakeStore {
...
func (s *FakeStore) LoadToVersionFn(
	fn func(ref id.StreamRef, maxVersion event.Version) ([]event.Event, error),
) *FakeStore {
...
func (s *FakeStore) LoadToTimestampFn(
	fn func(ref id.StreamRef, maxTime time.Time) ([]event.Event, error),
) *FakeStore {
...
func (s *FakeStore) AppendBatchFn(
	fn func(ref id.StreamRef, events []event.Event) error,
) *FakeStore {
	s.appendBatchFn = fn
...
func VersionQueryFn(
	called *bool,
) func(id.StreamRef, event.Version) ([]event.Event, error) {
	return func(_ id.StreamRef, _ event.Version) ([]event.Event, error) {
		*called = true
