...
`github.com/larsartmann/go-cqrs-lite/catalog/v2/d2` as the current standalone module.
...
| **Self-referential replace**   | Each child has `replace github.com/larsartmann/go-cqrs-lite/catalog/v2 => ../` — pointing at the thing it's pretending not to be part of. |
...
```
catalog/                          # ONE module: github.com/larsartmann/go-cqrs-lite/catalog/v2
...
| --------------------------------------------------------- | --------------------------------------------------------- |
| `github.com/larsartmann/go-cqrs-lite/catalog/v2/d2`       | `github.com/larsartmann/go-cqrs-lite/catalog/v2/d2`       |
| `github.com/larsartmann/go-cqrs-lite/catalog/v2/asyncapi` | `github.com/larsartmann/go-cqrs-lite/catalog/v2/asyncapi` |
| ...                                                       | (identical for all 5)                                     |
