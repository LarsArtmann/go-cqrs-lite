...
**Note:** This is a package-level split _within_ `core`, not a module split. The `core` module keeps all these packages. The benefit is locality: changing the outbox publisher doesn't require recompiling event builder tests.
...
_Report generated by architectural analysis of go-cqrs-lite multi-module structure._
