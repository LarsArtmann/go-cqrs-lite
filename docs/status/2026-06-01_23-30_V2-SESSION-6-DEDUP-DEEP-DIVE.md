...
The codebase has 22 `replace` directives in go.mod files pointing to local paths. These exist because no v2.0.0 tags have been pushed to the remote. The AGENTS.md says: *"replace directives required until v1.0.0 tags pushed to remote"*. 
