...
These are new public API symbols that no code inside the repo uses. For a library this is *expected* (consumers live outside the repo), but unproven features are a liability:
