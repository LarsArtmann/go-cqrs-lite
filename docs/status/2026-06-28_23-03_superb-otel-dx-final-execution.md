...
| 6   | **Decider go.mod eventtest fix**               | `90d50589` | Added `replace github.com/larsartmann/go-cqrs-lite/event/v4/eventtest => ../event/eventtest`. `GOWORK=off go test ./...` now passes in decider module.                                                                                            |
