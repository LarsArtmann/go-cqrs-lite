...
- **Committed unrelated files in the same commit** — TODO_LIST.md, idempotency/*, cmd/cqrs-lint/*, system/*, metaengine/*, stack/*, projectionhost/*, scheduling/*, middleware/*, retry/* — all got swept into `99fc1648e` because I ran `git add -A`. This violates atomic commit principle.
