...
_Report format: Markdown (.md) per explicit user request — overrides the status-report skill's HTML default (flagged per skill policy). Auto-commit daemon will absorb this file; no manual commit per harness rule._
