...
**Session Goal:** *"Consumers should NOT decide on infrastructure. Deployer chooses where data lives via simple one-line presets, with the option to split concerns across multiple databases."*
