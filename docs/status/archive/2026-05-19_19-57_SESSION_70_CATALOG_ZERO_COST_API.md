...
**High impact, medium effort:** 3. Storage `Dialect` interface (2-3h) — eliminates 5 pairs of near-identical files 4. File size compliance (2h) — split 7 oversized files

**Medium impact:** 5. Missing unit tests (2h) — builder, options, enricher, helpers 6. `Version` → `uint` (1h) — type safety improvement
