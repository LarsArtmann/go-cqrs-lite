...
goroutine per message (`router.go:30`: _"HandlerFunc's are executed parallel
when multiple messages was received"_). The Router is designed for high-throughput
