...
4. **Codify migration examples as compilable tests.** V3*MIGRATION.md had a broken code example. If it were an `Example*\*`function in a test file,`go test` would have caught it automatically.
