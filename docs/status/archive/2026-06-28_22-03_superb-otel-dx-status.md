...
| 4   | transport/http `go mod tidy` failed                                    | Missing `eventtest` replace directive — `go mod tidy` tried to fetch from remote                      | Added `replace github.com/larsartmann/go-cqrs-lite/event/v4/eventtest => ../../event/eventtest`                  |
