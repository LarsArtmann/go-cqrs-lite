...
2. **v5 removal execution** (ADR-0123 surfaces) — this plan was explicitly the *preparation*; the v5 milestone owns it.
...
9. **benchkit doc.go/README still say "targets *stack.Bundle"** — now false; docs lagged code.
