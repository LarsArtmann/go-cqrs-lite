...
| -- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- | ------ | ------------- |
|~~ 1  ~~|~~ Add implementation-status addendum to `event-query-model.md` (per-section DONE/DIFFERENT/NOT-STARTED, ADR-0114 style)                                                              ~~ done 2026-09-13 — 18-35 report §a3–§a15 (T03–T13)  |~~ High     ~~|~~ M      ~~|~~ Documentation ~~|
|~~ 2  ~~|~~ Replace the doc's `**Status:**` header: currently claims "THE model" while diverging from shipped truth                                                                            ~~ done 2026-09-13 — 18-35 §a3  |~~ High     ~~|~~ S      ~~|~~ Documentation ~~|
|~~ 3  ~~|~~ §4 example: `store.Execute(ctx, FindUser{...})` → `metaengine.ExecuteTyped[FindUser, FindUserResult](ctx, store, ...)` (`execute.go:681`)                                          ~~ done 2026-09-13 — 18-35 §a4  |~~ Medium   ~~|~~ S      ~~|~~ Documentation ~~|
|~~ 4  ~~|~~ §4/§5 examples: mark `On`/`OnTyped` deprecated → `OnRecord`/`OnRecordTyped` (removed v5, `fold.go:296-309`)                                                                        ~~ done 2026-09-13 — 18-35 §a5  |~~ Medium   ~~|~~ S      ~~|~~ Documentation ~~|
|~~ 5  ~~|~~ §5 ADT table: add `MultiEntry` (Multimap), `Append` (Log), `EdgeRemoval`; align with ADT enum incl. `stream_log`, `sorted_map` (`types.go:3-15`)                                   ~~ done 2026-09-13 — 18-35 §a6  |~~ High     ~~|~~ S      ~~|~~ Documentation ~~|
|~~ 6  ~~|~~ §6 read patterns: expand to the shipped 11-value enum (`types.go:24-38`)                                                                                                           ~~ done 2026-09-13 — 18-35 §a7  |~~ Medium   ~~|~~ S      ~~|~~ Documentation ~~|
|~~ 7  ~~|~~ §8 example: fix `rec.MetaData.Timestamp` to real `CommonMetadata` fields (`record/record.go:26-80`)                                                                                ~~ done 2026-09-13 — 18-35 §a8  |~~ High     ~~|~~ S      ~~|~~ Documentation ~~|
|~~ 8  ~~|~~ §8 example: replace `metaengine.RangeFilter("timestamp")` with real API (`WithRange` / `FilterOnField`)                                                                            ~~ done 2026-09-13 — 18-35 §a9  |~~ Medium   ~~|~~ S      ~~|~~ Documentation ~~|
|~~ 9  ~~|~~ Annotate Decision 1 as resolved-by-hybrid: `FilterOn` closures + `FilterOnField`/`SortOnField` pushdown, not Option B (`query.go:151-193`)                                         ~~ done 2026-09-13 — 18-35 §a10  |~~ High     ~~|~~ S      ~~|~~ Documentation ~~|
|~~ 10 ~~|~~ Annotate Decision 2: no `Store.Stream`; engine-level `iter.Seq2` exists (`engine.go:384`); `ScanPage` covers pagination only                                                       ~~ done 2026-09-13 — 18-35 §a11  |~~ Medium   ~~|~~ S      ~~|~~ Documentation ~~|
|~~ 11 ~~|~~ Verify then annotate Decision 3 (cross-projection queries): read `typed_reader_grouped.go` + `execute.go` inner paths                                                              ~~ done 2026-09-13 — 18-35 §a12  |~~ Medium   ~~|~~ S      ~~|~~ Documentation ~~|
|~~ 12 ~~|~~ Verify then annotate Decision 4: trace `catchup_state.go` vs "checkpoint == log tail → cutover" claim                                                                              ~~ done 2026-09-13 — 18-35 §a13  |~~ Medium   ~~|~~ S      ~~|~~ Documentation ~~|
|~~ 13 ~~|~~ §12 engine examples: SQLite+Pebble+**Dgraph** replaces Neo4j; add real roster of 10 engines                                                                                        ~~ done 2026-09-13 — 18-35 §a14  |~~ High     ~~|~~ S      ~~|~~ Documentation ~~|
|~~ 14 ~~|~~ Strike or annotate Bloom-filter structures (§5/§7/§12): no Bloom backend exists                                                                                                    ~~ done 2026-09-13 — 18-35 §a15  |~~ High     ~~|~~ S      ~~|~~ Documentation ~~|
|~~ 15 ~~|~~ §14 flow: rewrite to actual APIs (`AddEngine`/`RemoveEngine`/`SwapEngine`/`Replan`/`ReplanLayout`, shadow roles `roles.go`)                                                        ~~ done 2026-09-13 — 18-35 §a5  |~~ High     ~~|~~ S      ~~|~~ Documentation ~~|
|~~ 16 ~~|~~ Investigate `rule_shared_collection.go` vs §7's "five independent projections, zero coordination" claim; reconcile the contradiction                                               ~~ done 2026-09-13 — 18-35 §a6  |~~ High     ~~|~~ M      ~~|~~ Documentation ~~|
|~~ 17 ~~|~~ Map §11's 7 planner steps to source files (`fold_classify.go`, `infer_*.go`, `cost.go`, `layout*.go`, `auto_fold.go`, `typed_reader*.go`, `rules.go`/`plan_audit.go`) and annotate ~~ done 2026-09-13 — 18-35 §a7  |~~ High     ~~|~~ M      ~~|~~ Documentation ~~|
|~~ 18 ~~|~~ Verify §13 "developer NEVER writes" rows still hold (e.g. "no IndexSpec declarations" vs `layout.go` index planning)                                                               ~~ done 2026-09-13 — 18-35 §a8  |~~ Medium   ~~|~~ M      ~~|~~ Documentation ~~|
|~~ 19 ~~|~~ §10: annotate command/query/session logs as NOT STARTED; promote to ROADMAP or strike (blocked on Q1 below)                                                                        ~~ done 2026-09-13 — 18-35 §a9  |~~ Critical ~~|~~ S      ~~|~~ Documentation ~~|
|~~ 20 ~~|~~ §9 auth: mark as scope statement (nothing to implement)                                                                                                                            ~~ done 2026-09-13 — 18-35 §a10  |~~ Low      ~~|~~ S      ~~|~~ Documentation ~~|
|~~ 21 ~~|~~ §2 table: verify "singleflight, snapshots, state cache" optimization row against decider module                                                                                    ~~ done 2026-09-13 — 18-35 §a11  |~~ Low      ~~|~~ S      ~~|~~ Documentation ~~|
|~~ 22 ~~|~~ §7: add watcher zero-value delete-notification contract note                                                                                                                       ~~ done 2026-09-13 — 18-35 §a12  |~~ Low      ~~|~~ S      ~~|~~ Documentation ~~|
|~~ 23 ~~|~~ §11: confirm Volume scale-threshold warnings + write-amp budget default (3) match shipped behavior (`cost.go`, `rule_writeamp.go`)                                                 ~~ done 2026-09-13 — 18-35 §a13  |~~ Medium   ~~|~~ S      ~~|~~ Documentation ~~|
|~~ 24 ~~|~~ §12: align example planner outputs with actual `PlanResult`/`LogPlan` format                                                                                                       ~~ done 2026-09-13 — 18-35 §a14  |~~ Low      ~~|~~ S      ~~|~~ Documentation ~~|
|~~ 25 ~~|~~ §1-§3: mark as philosophy (no code claims) — removes the unfalsifiable "accurate" framing                                                                                          ~~ done 2026-09-13 — 18-35 §a15  |~~ Low      ~~|~~ S      ~~|~~ Documentation ~~|

### Group B — Coverage map: features the doc never mentions (the module grew far beyond §3's table)

| #  | Task                                                                                                                                                                                                                                                                                                                                                                     | Impact | Effort | Category      |
| -- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------ | ------ | ------------- |
|~~ 26 ~~|~~ Produce "features beyond the doc" list: materialized views (`materialized_view*.go`), replication (`replication*.go`, iroh), export/import, SSE (`sse*.go`), watchers, vector search, spatial, graphadapter, durability rules, `demote.go`, `backfill.go`, batch atomicity, `ApplyIdempotent`, `InTransaction`, catchup, priority config, plan-diff/versioning, failover ~~ done 2026-09-13 — 18-35 T14  |~~ High   ~~|~~ M      ~~|~~ Documentation ~~|
|~~ 27 ~~|~~ Document `ProjectionRole` (Active/DualUse/Migration/Backup) in metaengine README                                                                                                                                                                                                                                                                                         ~~ done 2026-09-13 — T15  |~~ Medium ~~|~~ M      ~~|~~ Documentation ~~|
|~~ 28 ~~|~~ README: add `On`/`OnTyped` → `OnRecord` migration note (v5 removal)                                                                                                                                                                                                                                                                                                      ~~ done 2026-09-13 — T15  |~~ Medium ~~|~~ S      ~~|~~ Documentation ~~|
|~~ 29 ~~|~~ Confirm README fold table covers `FoldEdgeRemove` + `FoldSkip`                                                                                                                                                                                                                                                                                                           ~~ done 2026-09-13 — T15  |~~ Low    ~~|~~ S      ~~|~~ Documentation ~~|
|~~ 30 ~~|~~ Verify membership-test (Set) pushdown path exists for SQL engines (§12's "UNIQUE index" claim)                                                                                                                                                                                                                                                                           ~~ done 2026-09-15/16 — TODO_LIST [x] double-verified  |~~ Medium ~~|~~ S      ~~|~~ Documentation ~~|
|~~ 31 ~~|~~ Verify graph traversal depth semantics (doc's `Depth` field) vs shipped `executeGraphNeighborsUndirected` (`execute.go:414`)                                                                                                                                                                                                                                             ~~ done 2026-09-15/16 — TODO_LIST [x] double-verified  |~~ Medium ~~|~~ S      ~~|~~ Documentation ~~|
|~~ 32 ~~|~~ Verify §5 "physical structures" mappings vs `StorageLayout` enum (`layout_type.go`)                                                                                                                                                                                                                                                                                      ~~ done 2026-09-13 — T02.6  |~~ Medium ~~|~~ M      ~~|~~ Documentation ~~|
|~~ 33 ~~|~~ Confirm degraded-pattern/write-amp warnings surface as doc §11 Step 7 promises (`doctor_degraded.go`)                                                                                                                                                                                                                                                                    ~~ done 2026-09-13 — T02.5/T12  |~~ Medium ~~|~~ S      ~~|~~ Documentation ~~|

### Group C — Process / tooling / hygiene

| #  | Task                                                                                                                | Impact   | Effort | Category      |
| -- | ------------------------------------------------------------------------------------------------------------------- | -------- | ------ | ------------- |
|~~ 34 ~~|~~ Repo-wide inbound-link sweep for `event-query-model.md` before any supersede/delete                                 ~~ done 2026-09-13 — T01  |~~ Medium   ~~|~~ S      ~~|~~ Documentation ~~|
|~~ 35 ~~|~~ Check whether `cmd/doc-check` scans `docs/planning/`; decide if it should                                           ~~ done 2026-09-13 — T01/T20  |~~ Medium   ~~|~~ S      ~~|~~ Tooling       ~~|
|~~ 36 ~~|~~ Decide planning-doc policy: living (gated, lockstep) vs archive (annotate once, never maintain) — blocked on Q2     ~~ done 2026-09-13 — T20 convention in AGENTS.md  |~~ Critical ~~|~~ S      ~~|~~ Process       ~~|
|~~ 37 ~~|~~ Add planning-doc status convention (Status header + addendum discipline) to AGENTS.md "Project Documentation Files" ~~ done 2026-09-13 — T20  |~~ Medium   ~~|~~ S      ~~|~~ Process       ~~|
|~~ 38 ~~|~~ Harvest this report's (f) items into `TODO_LIST.md`/`ROADMAP.md` (docs-health HARVEST)                              ~~ done 2026-09-13 — T21  |~~ High     ~~|~~ S      ~~|~~ Process       ~~|
|~~ 39 ~~|~~ Run docs-health VERIFY over `docs/planning/*.md`                                                                    ~~ done 2026-09-13 — T22 sibling sweep  |~~ Medium   ~~|~~ M      ~~|~~ Process       ~~|
| 40 | Sweep sibling planning docs for the same rot pattern (superseded-claim docs without addenda)                        | Medium   | M      | Process       |
|~~ 41 ~~|~~ Make doc-internal Go examples compile-checkable (or explicitly exempt planning docs)                                ~~ done 2026-09-13 — 17:40 notes  |~~ Medium   ~~|~~ L      ~~|~~ Quality       ~~|
|~~ 42 ~~|~~ Record this session's verified file:line map as a references note for future audits                                 ~~ done 2026-09-13 — README work absorbed (12-16 report)  |~~ Low      ~~|~~ S      ~~|~~ Documentation ~~|
...
|~~ 45 ~~|~~ File an ADR/addendum for "Dgraph + SQL recursive CTE instead of Neo4j" if none exists                               ~~ done 2026-09-13 — T19 ADR-0119/0129 cross-linked  |~~ Medium   ~~|~~ M      ~~|~~ Documentation ~~|
...
|~~ 47 ~~|~~ Decide whether Bloom-filter Set optimization is ever wanted (Q3)                                                                                               ~~ done 2026-09-13 — 15-55 §8  |~~ Low      ~~|~~ S      ~~|~~ Decision ~~|
|~~ 48 ~~|~~ Decide whether a dedicated graph engine beyond Dgraph/CTE is on the roadmap (Q3)                                                                               ~~ done 2026-09-13 — T19  |~~ Medium   ~~|~~ S      ~~|~~ Decision ~~|
|~~ 49 ~~|~~ Decide final audience for `docs/planning/` — consumers (must be truthful) vs archaeology (can be historical) (Q2)                                              ~~ done 2026-09-13 — T20  |~~ High     ~~|~~ S      ~~|~~ Decision ~~|
|~~ 50 ~~|~~ If §10 survives: sketch the command-log-as-event-stream design against `record/` + ADR-0117 (command lifecycle as events already exists — check overlap first) ~~ done 2026-09-13/15 — CommandsByActor + command.rejected (CHANGELOG)  |~~ High     ~~|~~ L      ~~|~~ Feature  ~~|
