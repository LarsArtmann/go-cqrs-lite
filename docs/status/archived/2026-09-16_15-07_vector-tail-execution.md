...
> **RESOLVED-BY-ROUTING (2026-09-19 docs-health 8th pass):** struck items above = verified shipped (vector tail (a)–(h), ADR-0140, dgraph floor — TODO_LIST `[x]` rows 2026-09-16). Open remainder: native ANN per engine → ROADMAP; remote-Turso/Doctor-live/coverage tails stay here + TODO_LIST vector section. ARCHIVED.
