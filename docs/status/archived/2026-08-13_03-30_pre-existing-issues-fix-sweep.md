...
11. Add CI step for standalone (`GOWORK=off`) builds — this was identified as a gap in the prior session <- OPEN. TODO_LIST 'Pin & Standalone-Build Hygiene' (#verify-standalone) + 'Code Quality' (#verify-ci)
