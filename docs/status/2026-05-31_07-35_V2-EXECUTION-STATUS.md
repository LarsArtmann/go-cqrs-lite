...
*Note: Batch D items M32-34 (ComponentTracer, metricName constants) were verified as NOT dead code — they're used in tests. Only the SpanFromContext wrapper was truly unused and was removed.*
