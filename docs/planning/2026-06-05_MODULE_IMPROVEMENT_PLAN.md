...
| Module      |   LoC | Coverage | Lint | doc.go | README   | errors.go | Files >350L | Score |
| ----------- | ----: | -------: | ---: | ------ | -------- | --------- | ----------- | ----- |
| event       | 6,658 |    89.4% | ✅ 0 | no     | ⚠️ stale | ✅        | 0           | 🟡    |
| catalog     | 9,319 |    86.0% | ✅ 0 | ✅     | ✅       | no        | 0           | 🟡    |
...
| watermill   |   752 |    92.6% | ✅ 0 | no     | no       | no        | 0           | 🟡    |
...
10. **2 files exceed 350-line limit**: `scripts/go-mod-graph-local/main.go` (412 — tool script), `catalog/internal/cattest/builders.go` (377 — test helper). **Zero production library files exceed the limit.**
