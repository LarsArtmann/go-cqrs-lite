...
| #   | St   | Phase | Task                                                                                                                                                                                                              | Impact      | Effort | Source      |
| --- | ---- | ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ------ | ----------- |
| 1   | ✅   | 1     | **Fix ADR-0069 index gap** — added to docs/README.md + docs/adr/README.md + CI check in verify-docs.sh                                                                                                           | P0 Critical | 5min   | Status d.1  |
