...
| Overlapping rules add noise | IMPROVEMENT_IDEAS #25: C025 exists *because* D006 is general — `CorrelateFindings` (`pipeline/config.go:47`) unused |
...
*Evidence base: `docs/status/2026-09-16_21-05_go-finding-v1.10.0-benefit-analysis-cqrs-lint.md` (all file:line citations verified 2026-09-16). Plans are point-in-time — re-verify claims before acting (status-report §50).*
