...
*Point-in-time snapshot. Living state: TODO_LIST.md. This plan surfaced no NEW tasks beyond TODO_LIST.md — every item maps to an existing open TODO (72/72 accounted). Harvest back via docs-health → HARVEST after execution.*
