...
The **materialize-vs-replay** decision is the single most valuable ES-specific capability. DataFusion cannot ask this question because its tables just _are_. metaengine can — if it has write/read statistics.
