...
Everything in this plan serves proving or disproving this hypothesis. If it's false, we need to know _before_ investing 4 weeks of implementation.
...
The design docs say: _"the meta-engine is a new project. It is not a module within go-cqrs-lite."_
