...
| T08 | Dead links: `RULES.md` stub with anchors + V007 DocURLs → ADR anchors (SARIF help URIs)                                        | 20%      | 30m    | M      | M           | — **DONE by follow-up session 2026-09-06: `cmd/cqrs-lint/RULES.md` exists with 204 anchors (first attempt failed on a quoting bug, status 02:40 §b1)** |
