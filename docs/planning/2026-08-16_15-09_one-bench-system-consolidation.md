...
**Date:** 2026-08-16
**Source task:** TODO_LIST.md "Code Quality" → *One bench system* (Effort: M)
**Status:** EXECUTING
...
| CI regression job | benchstat compare, `|| true` | **FIX** — never fails; this is the core defect |

**The architecture the user asked about is correct:** benchkit = SDK, cqrs-bench = CLI.
What the original TODO missed: `metaengine/bench` is *not* a redundant harness — it benchmarks
