...
naming storage layouts, the cost matrix can't exist, and the planner can't reason about *why*
...
makes `EXPLAIN` output show *why* an engine was chosen — the single biggest trust win for
consumers.
