...
> This is the **definitive** plan. Every TODO is broken into tasks of ≤12 min, sorted by importance/impact/effort/customer-value. The master table is the single source of truth.
...
| T63 | D005: add test for ADR-title skip                                     | L      | 8      | T62 |
| T64 | Print applied features in `--verbose` output (run.go)                 | L      | 8      | T30 |
