...
| T06 | **memory engine: DueClaimer + DedupStore** (mutex + lease timers + TTL map — the degraded reference) + conformance green | 4% | 🔥🔥 | S (60m) | Reference for all other engines; test default | T02, T03 |
...
| --- | --- | --- | --- |
| T01a | Draft ADR-0141 context+decision: 4 capability ADTs, capability-interface path v4.x, universal fold v5 | 12m | T01 |
...
P0.T01: "T01 ADR-0141" {shape: document}
