...
**Problem:** Consumers write a full CQRS system, then write a _second fake CQRS system_ (with dummy aggregate IDs, fake events, `CatalogCore` wrappers) just to feed the catalog builder. The catalog feels like a parallel shadow system.
