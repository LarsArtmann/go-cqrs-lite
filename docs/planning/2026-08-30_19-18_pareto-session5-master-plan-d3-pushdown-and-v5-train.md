...
| M26 | Error-code rename aggregate_*→stream_* + dashboards note; wire-tag SQL ALTER migrations; v5 CHANGELOG assembly; post-cut `Deprecated:` sweep | 100m | gate | M | L | M25 | §f 30–33 |
...
| K14 | Error-code rename aggregate_*→stream_* | 12m | K13 |
