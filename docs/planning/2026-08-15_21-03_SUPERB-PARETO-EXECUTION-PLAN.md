...
| T10 | Core defects 2 (kv.Cache shared *T, TypedQueryStore codec, ErrBinaryNotFound) + security hygiene (SECURITY.md, release.yml vulncheck, iroh pin)                                                                                         | 100% ✅ | high   | 90m    | T     | —                   | this           |
