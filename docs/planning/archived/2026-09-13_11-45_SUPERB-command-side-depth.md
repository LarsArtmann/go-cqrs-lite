> **RESOLVED-BY-ROUTING — docs-health 9th pass (2026-09-20):** EXECUTED: W1–W3 shipped 2026-09-13 (`decider.ExecuteCommandRef` + `CausedCommand`, `command.AsRecordPersisted`, upcast-composition pin); W4 completed — every gate leg green including the composed `#verify` S03 (2026-09-20, 16-39 report); the release train shipped `decider/v4.7.0`, `command/v4.11.0`, and the commandlifecycle tags in the 92-tag wave (2026-09-19). ADR-0138 (command sourcing) remains [BLOCKED] on consumer demand in [TODO_LIST.md](../../../TODO_LIST.md). Archived as a completed plan.
