...
```
catalog/
├── go.mod                    ← module github.com/larsartmann/go-cqrs-lite/catalog/v4
...
```
module github.com/larsartmann/go-cqrs-lite/catalog/v4/asyncapi

go 1.26.3

require (
    github.com/larsartmann/go-cqrs-lite/catalog/v4 v2.3.0
    github.com/go-faster/yaml v0.x.x
)

replace github.com/larsartmann/go-cqrs-lite/catalog/v4 => ../
```
