...
1-3 above, plus: 4. Update CHANGELOG persistence entry (fully wired, not just type def) 5. Add persistence row to FEATURES.md metaengine table 6. Consolidate CHANGELOG C038 duplication 7. Run `nix fmt` on changed files 8. Commit
