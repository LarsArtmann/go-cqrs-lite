...
| ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ | ------- | ------ | ----------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ~~T01~~ | ~~Cut + push `cmd/cqrs-lint` v4.9.0 (pins, standalone matrix, tag, install check) ⛔Q1 default: now~~ done (docs-health pass 2026-09-06)                                                                                               | ~~1%~~       | ~~60m~~ | ~~H~~  | ~~H~~       | ~~T02 — **DONE at `dece8ccab` + tag `cmd/cqrs-lint/v4.9.0` (deviation: F011's CHANGELOG stamp landed BEFORE the tag so the tag carries it)**~~             |
| ~~T02~~ | ~~V007 drift meta-test: repo `Deprecated:` markers ↔ tables, + negative tests (`stack/bench` etc.)~~ done (docs-health pass 2026-09-06)                                                                                                | ~~4%~~       | ~~45m~~ | ~~H~~  | ~~M~~       | ~~— **DONE at `1e12d7e8d` (attribution shredded by daemon commits 5c246ea56/eae55e0f8/7711bf0b6)**~~                                                       |
| ~~T03~~ | ~~Examples modernization: `getting-started` off `stack.NewMaterialize`; survey other 3 ⛔Q3 default: keep suppression~~ done (docs-health pass 2026-09-06)                                                                             | ~~4%~~       | ~~90m~~ | ~~H~~  | ~~H~~       | ~~— **DONE at `dece8ccab` (+ daemon f03ebaaa6/e3105d91b)**~~                                                                                               |
| ~~T04~~ | ~~Severity/confidence-vs-catalog meta-test (constructor-body parser + allowlist) + fix mismatches found~~ done (docs-health pass 2026-09-06)                                                                                           | ~~20%~~      | ~~60m~~ | ~~H~~  | ~~M~~       | ~~— **DONE at `fbb10c0bb` (14 split-brains fixed)**~~                                                                                                      |
| ~~T05~~ | ~~Suppression parser robustness tail: 2 directives/line, space normalization, `/* */` model, unmatched-end warn~~ done (docs-health pass 2026-09-06)                                                                                   | ~~20%~~      | ~~60m~~ | ~~M~~  | ~~M~~       | ~~— **DONE at `ebfb5bc17` (inverted test assertion fixed in `0e74e2296`)**~~                                                                               |
| ~~T06~~ | ~~Fix-provider unification: single edit spec, Metadata-only CanHandle, `--fix` E2E pipeline test~~ done (docs-health pass 2026-09-06)                                                                                                  | ~~20%~~      | ~~45m~~ | ~~M~~  | ~~M~~       | ~~— **DONE at `0e74e2296` + `e44da78fa` — including the E2E half: root cause was C003's fix anchoring, NOT upstream go-finding (see F031)**~~              |
| ~~T07~~ | ~~lintutil convergence: dot-import semantics, dead exports, `/v10+` suffix, path-based denylist~~ done (docs-health pass 2026-09-06)                                                                                                   | ~~20%~~      | ~~45m~~ | ~~M~~  | ~~L~~       | ~~— **DONE at `0e74e2296`**~~                                                                                                                              |
| ~~T08~~ | ~~Dead links: `RULES.md` stub with anchors + V007 DocURLs → ADR anchors (SARIF help URIs)~~ done (docs-health pass 2026-09-06)                                                                                                         | ~~20%~~      | ~~30m~~ | ~~M~~  | ~~M~~       | ~~— **DONE by follow-up session 2026-09-06: `cmd/cqrs-lint/RULES.md` exists with 204 anchors (first attempt failed on a quoting bug, status 02:40 §b1)**~~ |
| ~~T09~~ | ~~CI: self-lint gate + examples lint matrix + required-check wiring + V007 demo capture~~ done — CI wiring shipped 2026-09-06 (self-lint + examples jobs, V007-DEMO.md, check-lint-config; F040 required-checks residue open)          | ~~20%~~      | ~~45m~~ | ~~M~~  | ~~M~~       | ~~T01~~                                                                                                                                                    |
| ~~T10~~ | ~~Rule-ID gap documentation (A028, A031, P002–P005, S004, D004) + `rules --json` V007 metadata check~~ done — README rule-ID gap section + rules --json verified (commit d805c0af2)                                                    | ~~20%~~      | ~~30m~~ | ~~L~~  | ~~L~~       | ~~—~~                                                                                                                                                      |
| ~~T11~~ | ~~V007 runtime overhead measurement + record in `docs/benchmarks/`~~ done — docs/benchmarks/2026-09-06_cqrs-lint-v007-walltime.md (commit 5c4ebd0be)                                                                                   | ~~20%~~      | ~~30m~~ | ~~L~~  | ~~L~~       | ~~—~~                                                                                                                                                      |
| ~~T12~~ | ~~Ledger hygiene: TODO_LIST `---` artifact, AGENTS mid-gate-mutation prohibition + verify-log convention~~ done — F045 double-dash fix landed; F046 substance shipped early with the self-healing formatter guard                      | ~~20%~~      | ~~30m~~ | ~~L~~  | ~~L~~       | ~~—~~                                                                                                                                                      |
...
| ~~T22~~ | ~~Misc hardening: `-shuffle=on` eval, `-race -count=3` on suppression/fix, ruletest alias helper, preset V007 pins~~ done — shuffle eval ADOPT + race -count=3 green (confirmed by two sessions)                                       | ~~80% work~~ | ~~60m~~ | ~~L~~  | ~~L~~       | ~~T04~~                                                                                                                                                    |
| ~~T23~~ | ~~Design passes ⛔Q2: `v5-ready` preset/severity escalation design, dot-import detection design, typed-info integration design~~ done — designs recorded in docs/planning/2026-09-06_cqrs-lint-t23-design-passes.md (commit d341d95bd) | ~~80% work~~ | ~~60m~~ | ~~M~~  | ~~M~~       | ~~—~~                                                                                                                                                      |
| ~~T24~~ | ~~Sibling-repo replacement check (go-sse/cqrs-htmx links), docserver-CSS drift root cause → dep-bump checklist~~ done — sibling links verified + docserver-CSS root cause in CONTRIBUTING (commits d341d95bd, 35851f652)               | ~~80% work~~ | ~~30m~~ | ~~L~~  | ~~L~~       | ~~—~~                                                                                                                                                      |
...
| ID       | Task                                                                                                                                                  | Min    | Parent                                                                                                                                                                                                                                              |
| -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- | ------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ~~F001~~ | ~~Extract marker→symbol parser: walk `// Deprecated:` ADR-tagged markers, capture following declaration~~ done (docs-health pass 2026-09-06)          | ~~12~~ | ~~T02~~                                                                                                                                                                                                                                             |
| ~~F002~~ | ~~Map declarations to (module, exported symbol); diff vs `deprecatedV5Symbols/Modules` tables~~ done (docs-health pass 2026-09-06)                    | ~~12~~ | ~~T02~~                                                                                                                                                                                                                                             |
| ~~F003~~ | ~~Encode allowlist file for intentionally-uncovered markers; fail meta-test otherwise~~ done (docs-health pass 2026-09-06)                            | ~~12~~ | ~~T02~~                                                                                                                                                                                                                                             |
| ~~F004~~ | ~~Negative tests: `stack/bench`, `stack/memory` subpackages, stack-root survivors don't fire~~ done (docs-health pass 2026-09-06)                     | ~~12~~ | ~~T02~~                                                                                                                                                                                                                                             |
| ~~F005~~ | ~~Run meta-test in suite; document coverage contract in `v007.go` doc comment~~ done (docs-health pass 2026-09-06)                                    | ~~12~~ | ~~T02~~                                                                                                                                                                                                                                             |
| ~~F006~~ | ~~Check `const version` vs latest tag (`TestVersionMatchesLatestTag`); bump if needed~~ done (docs-health pass 2026-09-06)                            | ~~12~~ | ~~T01~~                                                                                                                                                                                                                                             |
| ~~F007~~ | ~~Sweep `cmd/cqrs-lint` sibling pins; `go mod tidy`; commit pins~~ done (docs-health pass 2026-09-06)                                                 | ~~12~~ | ~~T01~~                                                                                                                                                                                                                                             |
| ~~F008~~ | ~~`GOWORK=off` standalone build + `go test -run ZZNONE` matrix for the module~~ done (docs-health pass 2026-09-06)                                    | ~~12~~ | ~~T01~~                                                                                                                                                                                                                                             |
| ~~F009~~ | ~~`scripts/tag-release.sh` cut v4.9.0 (annotated); post-bump assert + clean install check~~ done (docs-health pass 2026-09-06)                        | ~~12~~ | ~~T01~~                                                                                                                                                                                                                                             |
| ~~F010~~ | ~~Push tag; `go install …/cmd/cqrs-lint/v4@latest`; verify `--version` + 204 rules~~ done (docs-health pass 2026-09-06)                               | ~~12~~ | ~~T01~~                                                                                                                                                                                                                                             |
| ~~F011~~ | ~~Stamp CHANGELOG release section for v4.9.0; changelog-symbols gate~~ done (docs-health pass 2026-09-06)                                             | ~~12~~ | ~~T01 — **DONE early (before the tag, deliberate reorder)**~~                                                                                                                                                                                       |
| ~~F012~~ | ~~Survey all 4 examples for v5-removed usage; write inventory into plan appendix~~ done (docs-health pass 2026-09-06)                                 | ~~12~~ | ~~T03~~                                                                                                                                                                                                                                             |
| ~~F013~~ | ~~`getting-started`: design smallest honest rewrite off `Materialize` (metaengine auto-projection)~~ done (docs-health pass 2026-09-06)               | ~~12~~ | ~~T03~~                                                                                                                                                                                                                                             |
| ~~F014~~ | ~~Implement rewrite part 1: imports, store wiring, bundle→system swap~~ done (docs-health pass 2026-09-06)                                            | ~~12~~ | ~~T03~~                                                                                                                                                                                                                                             |
| ~~F015~~ | ~~Implement rewrite part 2: read path + tests green~~ done (docs-health pass 2026-09-06)                                                              | ~~12~~ | ~~T03~~                                                                                                                                                                                                                                             |
| ~~F016~~ | ~~Update example README + skill references; full example test run~~ done (docs-health pass 2026-09-06)                                                | ~~12~~ | ~~T03~~                                                                                                                                                                                                                                             |
| ~~F017~~ | ~~Document examples self-lint policy decision in AGENTS (⛔Q3 default: keep suppression)~~ done (docs-health pass 2026-09-06)                         | ~~12~~ | ~~T03~~                                                                                                                                                                                                                                             |
| ~~F018~~ | ~~Lint all 4 examples; capture before/after finding counts~~ done (docs-health pass 2026-09-06)                                                       | ~~12~~ | ~~T03~~                                                                                                                                                                                                                                             |
| ~~F019~~ | ~~Constructor-span locator: `go/parser`-based `NewXXXDetector` body extraction~~ done (docs-health pass 2026-09-06)                                   | ~~12~~ | ~~T04~~                                                                                                                                                                                                                                             |
| ~~F020~~ | ~~Severity/confidence literal extraction within spans; map to catalog IDs~~ done (docs-health pass 2026-09-06)                                        | ~~12~~ | ~~T04~~                                                                                                                                                                                                                                             |
| ~~F021~~ | ~~Allowlist encoding for intentionally conditional severities~~ done (docs-health pass 2026-09-06)                                                    | ~~12~~ | ~~T04~~                                                                                                                                                                                                                                             |
| ~~F022~~ | ~~Fix mismatches the test finds (if any); rerun suite~~ done (docs-health pass 2026-09-06)                                                            | ~~12~~ | ~~T04~~                                                                                                                                                                                                                                             |
| ~~F023~~ | ~~Add meta-test to `meta_test.go`; note in README~~ done (docs-health pass 2026-09-06)                                                                | ~~12~~ | ~~T04~~                                                                                                                                                                                                                                             |
| ~~F024~~ | ~~Parse ALL directives on one line (second `ignore(...)` currently swallowed) + tests~~ done (docs-health pass 2026-09-06)                            | ~~12~~ | ~~T05~~                                                                                                                                                                                                                                             |
| ~~F025~~ | ~~Normalize multi-space `//  cqrs-lint:` prefix + tests~~ done (docs-health pass 2026-09-06)                                                          | ~~12~~ | ~~T05~~                                                                                                                                                                                                                                             |
| ~~F026~~ | ~~Model `/* */` block comments so directives inside are not honored + tests~~ done (docs-health pass 2026-09-06)                                      | ~~12~~ | ~~T05~~                                                                                                                                                                                                                                             |
| ~~F027~~ | ~~Warn on unmatched `ignore-end` / unterminated `ignore-start` under `--fail-on-stale` + tests~~ done (docs-health pass 2026-09-06)                   | ~~12~~ | ~~T05~~                                                                                                                                                                                                                                             |
| ~~F028~~ | ~~Update suppression docs in `main.go` long-help + README~~ done (docs-health pass 2026-09-06)                                                        | ~~12~~ | ~~T05~~                                                                                                                                                                                                                                             |
| ~~F029~~ | ~~Unify edit spec: `HasCodeChange` consults Metadata; `CanHandle` accepts either source~~ done (docs-health pass 2026-09-06)                          | ~~12~~ | ~~T06~~                                                                                                                                                                                                                                             |
| ~~F030~~ | ~~Metadata-only round-trip test~~ done (docs-health pass 2026-09-06)                                                                                  | ~~12~~ | ~~T06~~                                                                                                                                                                                                                                             |
| ~~F031~~ | ~~E2E: `cqrs-lint --fix` on temp fixture; assert correct occurrence edited~~ done at `e44da78fa`, `2e083bcb3`                                         | ~~12~~ | ~~T06 — **RESOLVED at `e44da78fa`: `--fix` writes correctly through the real pipeline — root cause was C003 anchoring its Direct fix at the function declaration (the occurrence-safe provider rightly refused); NOT an upstream go-finding bug**~~ |
| ~~F032~~ | ~~Converge dot-import semantics (drop branch or return `(path, dotted)`); update call sites~~ done (docs-health pass 2026-09-06)                      | ~~12~~ | ~~T07~~                                                                                                                                                                                                                                             |
| ~~F033~~ | ~~Unexport/remove `ImportQualifierMap`, `SelectorIdent`; fix tests~~ done (docs-health pass 2026-09-06)                                               | ~~12~~ | ~~T07~~                                                                                                                                                                                                                                             |
| ~~F034~~ | ~~`lastSegment`: strip `/v10`+ suffixes; test~~ done (docs-health pass 2026-09-06)                                                                    | ~~12~~ | ~~T07~~                                                                                                                                                                                                                                             |
| ~~F035~~ | ~~Denylist: match import paths instead of bare qualifier names; test~~ done (docs-health pass 2026-09-06)                                             | ~~12~~ | ~~T07~~                                                                                                                                                                                                                                             |
| ~~F036~~ | ~~`RULES.md` stub with anchors for all 204 catalog entries (generated from catalog)~~ done (docs-health pass 2026-09-06)                              | ~~12~~ | ~~T08~~                                                                                                                                                                                                                                             |
| ~~F037~~ | ~~V007 DocURL → ADR-0114/0123/0126 anchors; script-audit all DocURLs resolve~~ done (docs-health pass 2026-09-06)                                     | ~~12~~ | ~~T08~~                                                                                                                                                                                                                                             |
| ~~F038~~ | ~~CI job: cqrs-lint self-lint (exit-code policy: errors block, warnings report)~~ done (docs-health pass 2026-09-06)                                  | ~~12~~ | ~~T09~~                                                                                                                                                                                                                                             |
| ~~F039~~ | ~~CI job: examples lint matrix~~ done (docs-health pass 2026-09-06)                                                                                   | ~~12~~ | ~~T09~~                                                                                                                                                                                                                                             |
| ~~F040~~ | ~~Ensure `check-lint-config` is a required check~~ done (docs-health pass 2026-09-06)                                                                 | ~~12~~ | ~~T09~~                                                                                                                                                                                                                                             |
| ~~F041~~ | ~~Capture V007 demo output into docs for release notes~~ done (docs-health pass 2026-09-06)                                                           | ~~12~~ | ~~T09~~                                                                                                                                                                                                                                             |
| ~~F042~~ | ~~Rule-ID gap documentation in README (A028, A031, P002–P005, S004, D004)~~ done (docs-health pass 2026-09-06)                                        | ~~12~~ | ~~T10~~                                                                                                                                                                                                                                             |
| ~~F043~~ | ~~Verify `rules --json` emits V007 metadata for editor consumers~~ done (docs-health pass 2026-09-06)                                                 | ~~12~~ | ~~T10~~                                                                                                                                                                                                                                             |
| ~~F044~~ | ~~Benchmark self-lint wall time with/without V007; record in `docs/benchmarks/`~~ done (docs-health pass 2026-09-06)                                  | ~~12~~ | ~~T11~~                                                                                                                                                                                                                                             |
| ~~F045~~ | ~~Fix TODO_LIST double-`---` artifact from session insertion~~ done (docs-health pass 2026-09-06)                                                     | ~~12~~ | ~~T12~~                                                                                                                                                                                                                                             |
| ~~F046~~ | ~~AGENTS: add mid-gate tree-mutation prohibition + verify-log convention~~ done (docs-health pass 2026-09-06)                                         | ~~12~~ | ~~T12~~                                                                                                                                                                                                                                             |
| ~~F047~~ | ~~Audit C001–C007: read detectors, check emitted severity/confidence vs catalog, note FPs~~ done (docs-health pass 2026-09-06)                        | ~~12~~ | ~~T13~~                                                                                                                                                                                                                                             |
| ~~F048~~ | ~~Audit C008–C014 same checklist~~ done (docs-health pass 2026-09-06)                                                                                 | ~~12~~ | ~~T13~~                                                                                                                                                                                                                                             |
| ~~F049~~ | ~~Fix mechanical findings from C001–C014 pass; run correctness tests~~ done (docs-health pass 2026-09-06)                                             | ~~12~~ | ~~T13~~                                                                                                                                                                                                                                             |
| ~~F050~~ | ~~Audit C015–C021~~ done (docs-health pass 2026-09-06)                                                                                                | ~~12~~ | ~~T14~~                                                                                                                                                                                                                                             |
| ~~F051~~ | ~~Audit C022–C028~~ done (docs-health pass 2026-09-06)                                                                                                | ~~12~~ | ~~T14~~                                                                                                                                                                                                                                             |
...
| ~~F073~~ | ~~Review `feature_profile.go` (587 lines — split candidate)~~ done — feature_profile_split_594-to-3-files_(207bdc46f_wave)                            | ~~12~~ | ~~T20~~                                                                                                                                                                                                                                             |
...
| ~~F082~~ | ~~Scorecard: add deprecated-module usage panel (F030/V007 data) — design + implement~~ done — scorecard_deprecated_panel_(207bdc46f_wave)             | ~~12~~ | ~~T21~~                                                                                                                                                                                                                                             |
| ~~F083~~ | ~~Health policy test: confirm/document V007 deduction behavior~~ done — health_policy_test_(207bdc46f_wave)                                           | ~~12~~ | ~~T21~~                                                                                                                                                                                                                                             |
| F084     | Fix mechanical findings from T21 reviews; run CLI tests                                                                                               | 12     | T21                                                                                                                                                                                                                                                 |
| ~~F085~~ | ~~`-shuffle=on` evaluation run on cqrs-lint suite; record verdict~~ done — shuffle_eval_ADOPT                                                         | ~~12~~ | ~~T22~~                                                                                                                                                                                                                                             |
| ~~F086~~ | ~~`-race -count=3` on suppression + fix packages~~ done — race_-count=3_green                                                                         | ~~12~~ | ~~T22~~                                                                                                                                                                                                                                             |
| ~~F087~~ | ~~ruletest: alias-import fixture helper~~ done — ruletest.AliasedImportSource_(d341d95bd)                                                             | ~~12~~ | ~~T22~~                                                                                                                                                                                                                                             |
| ~~F088~~ | ~~Presets: encode V007/F030 on/off policy in preset definitions~~ done — preset_V007/F030_policy_pins_(d341d95bd)                                     | ~~12~~ | ~~T22~~                                                                                                                                                                                                                                             |
| ~~F089~~ | ~~`v5-ready` preset design doc (⛔Q2 severity escalation mechanism)~~ done — design_doc_(t23_passes)                                                  | ~~12~~ | ~~T23~~                                                                                                                                                                                                                                             |
| ~~F090~~ | ~~Dot-import detection design (V007 scope extension)~~ done — design_doc_(t23_passes)                                                                 | ~~12~~ | ~~T23~~                                                                                                                                                                                                                                             |
| ~~F091~~ | ~~Typed-info (`packages.Types`) integration design for name-heuristic FPs (C008/C035 class)~~ done — design_doc_(t23_passes)                          | ~~12~~ | ~~T23~~                                                                                                                                                                                                                                             |
| ~~F092~~ | ~~Verify go-sse / cqrs-htmx replacement links in F030 findings are current~~ done — verified_session-3_log                                            | ~~12~~ | ~~T24~~                                                                                                                                                                                                                                             |
| ~~F093~~ | ~~Docserver CSS drift root cause (templ-components bump) → dep-bump checklist entry in CONTRIBUTING~~ done — CONTRIBUTING_regenerate_rule_(35851f652) | ~~12~~ | ~~T24~~                                                                                                                                                                                                                                             |
...
| ~~F096~~ | ~~Update plan file: check off completed tasks, annotate deviations~~ done (docs-health pass 2026-09-06)                                               | ~~12~~ | ~~gate~~                                                                                                                                                                                                                                            |
