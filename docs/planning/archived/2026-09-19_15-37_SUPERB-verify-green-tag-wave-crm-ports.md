...
**Concurrent-session reality:** benchkit statistical-rigor workstream is active RIGHT NOW (dirty files: benchkit/_, cmd/cqrs-bench/_, workflows). This plan does not touch those files; ledger edits stay theirs.
