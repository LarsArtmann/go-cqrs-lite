...
| ~~T02: GraphBackend delete~~ **CORRECTION (2026-08-29):** shipped — GraphBackend deleted (ADR-0113).       | ⏳ PENDING | 15 files, not on critical path                                                                                                                                                                                              |
| ~~T03: Registry~~ **CORRECTION (2026-08-29):** shipped — metaengine/registry.go is the sole registry. → metaengine/    | ⏳ PENDING |                                                                                                                                                                                                                             |
