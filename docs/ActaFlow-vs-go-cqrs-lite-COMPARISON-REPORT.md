...
**Key finding:** These projects are **not competitors** — they are architectural layers that could compose into a single system. ActaFlow owns the *concurrency and computation* layer; go-cqrs-lite owns the *persistence and domain modeling* layer.
