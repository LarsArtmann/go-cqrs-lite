...
require (
	...
	github.com/larsartmann/go-cqrs-lite/stack/v4 v4.2.1-0.20260807213449-e72b2d7a16d0
	github.com/larsartmann/go-cqrs-lite/storage/v4 v4.5.1-0.20260807213449-e72b2d7a16d0
...
require (
	...
	github.com/larsartmann/go-cqrs-lite/flightrecorder/v4 v4.0.0-20260807213449-e72b2d7a16d0 // indirect
