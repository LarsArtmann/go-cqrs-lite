...
require (
	...
	github.com/larsartmann/go-cqrs-lite/storage/v4 v4.5.1-0.20260806063227-a19b9d370eaa
...
require (
	...
	github.com/larsartmann/go-cqrs-lite/flightrecorder/v4 v4.0.0-20260806063227-a19b9d370eaa // indirect
