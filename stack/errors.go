...
var (
	...
	ErrMissingEventStore = event.NewRejection(
	...
	ErrMissingPublisher = event.NewRejection(
	...
	ErrMissingReadModels = event.NewRejection(
	...
	ErrMissingJournal = event.NewRejection(
	...
	ErrMissingSubscriber = event.NewRejection(
	...
	ErrMissingCheckpoint = event.NewRejection(
	...
	ErrMissingQueryStore = event.NewRejection(
