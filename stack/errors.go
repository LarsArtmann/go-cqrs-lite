...
var (
	...
	ErrEmpty error = errorfamily.NewRejection(
		"stack.bundle_empty",
	...
	ErrMissingEventStore error = errorfamily.NewRejection(
	...
	ErrMissingPublisher error = errorfamily.NewRejection(
	...
	ErrMissingReadModels error = errorfamily.NewRejection(
	...
	ErrMissingJournal error = errorfamily.NewRejection(
	...
	ErrMissingSubscriber error = errorfamily.NewRejection(
	...
	ErrMissingCheckpoint error = errorfamily.NewRejection(
	...
	ErrMissingQueryStore error = errorfamily.NewRejection(
