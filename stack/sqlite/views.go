...
func buildViewOptions(cfg config, backend *storage.SQLBackend, sqlDB *sql.DB) ([]stack.Option, error) {
	if cfg.viewDSN == "" {
...
func buildSecondaryViewOptions(cfg config, backend *storage.SQLBackend, sqlDB *sql.DB) ([]stack.Option, error) {
