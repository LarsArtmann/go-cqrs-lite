...
require github.com/larsartmann/go-cqrs-lite/event/v3 v3.3.0
...
require (
	...
	github.com/larsartmann/go-cqrs-lite/schema/v3 v3.0.0 // indirect
	github.com/larsartmann/go-cqrs-lite/snapshot/v3 v3.3.0 // indirect
	github.com/larsartmann/go-cqrs-lite/storage/memory/v3 v3.0.0 // indirect
