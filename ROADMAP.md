...
what remains is the iroh standalone-pin repair, the skill-reference
propagation wave, and the matview safety tail (Doctor-section test,
bench-regression extension).
