...
| ------------ | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [Unreleased] | —          | • **Metaengine v2** (ADRs 0111-0119): `record/` module, Record-aware folds, auto-projection, engine extractions, tombstone deprecation<br/>• **Aggregate pushdown**: 5 interfaces on DuckDB/SQLite/Postgres, GROUP BY 4.4x faster<br/>• **GraphBackend cleanup**: removed from 4 engines (-433 lines)<br/>• **bbolt storage backend** + SQLite CGo driver (`WithDriverName`)<br/>• **cqrs-lint 186→202 rules** (metaengine detection, resilience, observability, concurrency rules)<br/>• **cqrs-bench/benchkit**: resident memory, strict mode, 4-backend comparison<br/>• **System/ hardening**: plan-drift detection, YAML config, HealthCheck on all 6 engines, orderedEngines<br/>• **Dedup to 0** + helper extraction (`DeferClose`, `TitleCase`/`Truncate`)<br/>• **Metadata deprecation**: `EnsureCustom` → `WithCustom`<br/>• **CBOR bugfix** + **retry/ deprecated** (re-export shim)<br/>14 tags pushed to `origin` |
