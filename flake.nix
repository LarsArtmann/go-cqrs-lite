      ...
      perSystem =
        ...
        in
        {
          ...
          packages.cqrs-lint = (pkgs.buildGoModule.override { go = pkgs.go_1_26; }) {
            ...
            vendorHash = "sha256-E1qFSmwEgywVDAyH88QUMhwCyw+ZocOpTk4h59Aoh6w=";
            proxyVendor = true;
            ...
            verify =
              mkApp "verify" [ goPkg pkgs.golangci-lint pkgs.bash pkgs.findutils pkgs.gnugrep pkgs.gcc ]
                ''
                  ...
                  echo "=== Doc Check ===" && (cd cmd/doc-check && GOWORK=off GOEXPERIMENT=jsonv2 ${goPkg}/bin/go run . ../../SKILL.md ../../.agents/skills/go-cqrs-lite/references/*.md ../../AGENTS.md ../../README.md ../../TODO_LIST.md ../../ROADMAP.md ../../FEATURES.md ../../CONTRIBUTING.md) && \
