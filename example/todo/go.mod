...
require (
	...
	github.com/larsartmann/go-cqrs-lite/stack/pebble/v2 v2.0.0-20260621021422-a40795cd82f9
	github.com/larsartmann/go-cqrs-lite/stack/v2 v2.0.0-20260621021422-a40795cd82f9
