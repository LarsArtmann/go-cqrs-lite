module github.com/larsartmann/go-cqrs-lite/example/getting-started
...
require (
	...
	github.com/larsartmann/go-cqrs-lite/listing/v3 v3.6.0 // indirect
	github.com/larsartmann/go-cqrs-lite/otel/v3 v3.7.3 // indirect
	github.com/larsartmann/go-cqrs-lite/projection/v3 v3.7.3 // indirect
	github.com/larsartmann/go-cqrs-lite/query/v3 v3.7.3 // indirect
