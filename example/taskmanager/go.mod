...
require (
	...
	github.com/larsartmann/go-cqrs-lite/deriver/v3 v3.0.0-00010101000000-000000000000
...
require (
	...
	github.com/larsartmann/go-cqrs-lite/dedup/v3 v3.0.0-20260705234932-69cdd065e044 // indirect
