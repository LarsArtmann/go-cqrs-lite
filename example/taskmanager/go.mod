...
require github.com/larsartmann/go-cqrs-lite/codec/v3 v3.0.0-00010101000000-000000000000
...
require (
	...
	github.com/larsartmann/go-cqrs-lite/dedup/v3 v3.0.0-00010101000000-000000000000 // indirect
