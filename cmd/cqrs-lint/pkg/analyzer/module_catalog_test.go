...
func TestCatalogEveryGoWorkModuleCovered(t *testing.T) {
	...
	excludedModules := map[string]string{
		...
		"metaengine/otelobserver":        "sub-package (covered by metaengine)",
		...
		"metaengine/mysqlengine":         "sub-engine (covered by metaengine)",
		...
		"metaengine/tursoengine":         "sub-engine (covered by metaengine)",
		...
		"storage/bbolt":                  "low-level Bolt store (covered by stack/bbolt)",
		"storage/backuptest":             "test helper sub-package (shared by bbolt + pebble)",
