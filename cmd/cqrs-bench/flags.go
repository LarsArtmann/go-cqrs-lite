...
type BenchFlags struct {
	...
	Strict         bool              `default:"false"  flag:"strict"                   help:"Fail on skipped phases + NOISY headline metrics with --repeat N (CI gate)"`
...
type RunFlags struct {
	...
	IncludeRuns bool              `default:"false" flag:"include-runs" help:"With --format manifest: serialize every repeat run (runs[]) alongside the median — file grows N-fold"`
}
