...
require (
	...
	github.com/larsartmann/go-cqrs-lite/stack/duckdb/v4 v4.0.0-20260731015014-d87b8023044a
...
require (
	...
	github.com/larsartmann/go-cqrs-lite/storage/v4 v4.4.1-0.20260731015014-d87b8023044a // indirect
