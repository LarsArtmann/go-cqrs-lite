...
require (
	...
	github.com/larsartmann/go-cqrs-lite/stack/duckdb/v4 v4.0.0-20260731030730-75db92fab89d
...
require (
	...
	github.com/larsartmann/go-cqrs-lite/storage/v4 v4.4.1-0.20260731030730-75db92fab89d // indirect
