...
require (
	github.com/larsartmann/go-cqrs-lite/benchkit/v4 v4.0.0-20260723153958-c93762f0b7d0
	github.com/larsartmann/go-cqrs-lite/codec/v4 v4.0.4
	github.com/larsartmann/go-cqrs-lite/stack/memory/v4 v4.0.2
	github.com/larsartmann/go-cqrs-lite/stack/pebble/v4 v4.0.2
	github.com/larsartmann/go-cqrs-lite/stack/sqlite/v4 v4.0.2
