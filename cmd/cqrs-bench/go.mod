...
require (
	...
	github.com/larsartmann/go-cqrs-lite/benchkit/v4 v4.6.0
	github.com/larsartmann/go-cqrs-lite/metaengine/v4 v4.14.0
	github.com/larsartmann/go-cqrs-lite/stack/bbolt/v4 v4.2.1
	github.com/larsartmann/go-cqrs-lite/stack/duckdb/v4 v4.2.1
	github.com/larsartmann/go-cqrs-lite/stack/memory/v4 v4.4.1
	github.com/larsartmann/go-cqrs-lite/stack/mysql/v4 v4.2.1
	github.com/larsartmann/go-cqrs-lite/stack/pebble/v4 v4.4.1
	github.com/larsartmann/go-cqrs-lite/stack/postgres/v4 v4.4.1
	github.com/larsartmann/go-cqrs-lite/stack/sqlite/v4 v4.3.2
...
require (
	...
	github.com/larsartmann/go-output/markup v0.38.1 // indirect
	github.com/larsartmann/go-output/plantuml v0.38.0 // indirect
	github.com/larsartmann/go-output/serialization v0.38.1 // indirect
	github.com/larsartmann/go-output/tree v0.38.1 // indirect
