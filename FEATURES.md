...
| Vector ADT                            | k-NN similarity search (cosine/euclidean/dot) on EVERY engine (2026-09-15): Memory/PG/MySQL/sqlite+Turso/Pebble/bbolt/badger/Dgraph brute-force, DuckDB + libSQL SQL-side pushdown, all with `VectorFilterBackend` + `VectorCounter`; ANN indexes remain trigger-gated (ROADMAP). ADR-0085                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | 🧪     |
