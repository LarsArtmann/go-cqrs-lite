...
| Metadata              | `Metadata` struct: embeds `Tracing` (CorrelationID, CausationID, UserID, RequestID), `Source`, `IPAddress`, `UserAgent`, `Causation` (*Causation), `Custom` (map[MetadataKey]string) — ADR-0031 typed split, ADR-0114 removed Tombstone field                                                                                               | ✅     |
...
| Domain-event deletion | Deletion is a domain event (ADR-0114): emit `"entity.deleted"` events; detect via `listing.WithDeleteTypes`, `stack.Materialize.DeleteTypes`, or `metaengine.Remove`                                                                                                                                                                        | ✅     |
