...
require (
	...
	github.com/larsartmann/go-cqrs-lite/storage/pebble/v3 v3.7.3
	github.com/larsartmann/go-cqrs-lite/storage/v3 v3.7.3
...
require (
	...
	github.com/larsartmann/go-cqrs-lite/kv/v3 v3.7.3 // indirect
	github.com/larsartmann/go-cqrs-lite/projection/v3 v3.7.3 // indirect
