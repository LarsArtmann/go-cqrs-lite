...
require (
	...
	github.com/larsartmann/go-cqrs-lite/idempotency/kvstore/v4 v4.1.0
	github.com/larsartmann/go-cqrs-lite/idempotency/sqlstore/v4 v4.1.0
	...
	github.com/larsartmann/go-cqrs-lite/signing/v4 v4.1.0
