...
require (
	...
	github.com/larsartmann/go-cqrs-lite/listing/v4 v4.0.1
	...
	github.com/larsartmann/go-cqrs-lite/scheduling/v4 v4.0.1
...
replace (
	...
	github.com/larsartmann/go-cqrs-lite/scheduling/v4 => ../scheduling
