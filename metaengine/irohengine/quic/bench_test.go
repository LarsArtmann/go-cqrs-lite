...
// BenchmarkQuicMapSet_Pooled measures throughput with persistent BiStream
// pooling enabled (WithStreamPooling). Compare with BenchmarkQuicMapSet
// to see the overhead reduction from eliminating per-op stream creation.
func BenchmarkQuicMapSet_Pooled(b *testing.B) {
	ctx := context.Background()
