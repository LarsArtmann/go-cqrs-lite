...
var (
	...
	errNotQueryMeta     = errors.New("query does not implement queryMeta — pass a metaengine.Query[Q,R]")
	...
	errExecuteTypeMismatch = errors.New("metaengine.ExecuteTyped: result type does not match expected")
