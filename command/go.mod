module github.com/larsartmann/go-cqrs-lite/command/v2

go 1.26.3

require (
	github.com/larsartmann/go-cqrs-lite/dispatcher/v2 v2.6.0
...
require github.com/larsartmann/go-cqrs-lite/query/v2 v2.6.0 // indirect
