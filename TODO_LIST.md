...
- [x] ~~Write getting-started README section~~ — DONE (Session 112, added Decider pattern example + module READMEs)
...
- [x] ~~Add module READMEs~~ — DONE (Session 112, core/README.md + storage/README.md + catalog/README.md)
