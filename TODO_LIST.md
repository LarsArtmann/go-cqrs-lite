...
- [ ] Fix `Register()` error semantics to use `ErrDispatcherClosed` (source: 2026-04-02_22-58)
...
- [ ] Fix `MemoryStore.LoadFromVersion` to copy slice instead of returning sub-slice (source: 2026-04-02_23-02)
...
- [ ] Update `example/user/` to use xtypes, middleware, and repository (source: 2026-04-08_19-45)
...
- [ ] Create/update CONTRIBUTING.md with deduplication guidelines (source: 2026-04-08_19-45, 2026-04-05_20-23, ROADMAP.md)
...
- [ ] Add `aggregate.Repository` interface (source: 2026-04-02_23-02, 2026-04-02_22-58)
- [ ] Remove dead exports: `query.Result[T]`, `event.StreamOptions`, `BatchSize`, `Streamer` (source: 2026-04-02_23-02)
- [ ] Remove unused sentinels: `ErrCommandValidation`, `ErrQueryValidation`, `ErrInvalidEventType` (source: 2026-04-02_23-02)
- [ ] Commit `RecordEvent` rename (source: 2026-04-02_22-58)
- [ ] Remove duplicated `Lifecycle` methods (source: 2026-04-02_22-58)
...
- [ ] Wire `example/user/aggregate.go` to use catalog-aware event constructors `NewUserCreated`/`NewUserEmailChanged` (source: 2026-04-12_00-57)
...
- [ ] Add tests for `EventRetry()` middleware function (source: 2026-04-08_19-45)
...
- [ ] Create `.github/workflows/test.yml` and `.github/workflows/lint.yml` CI workflows (source: 2026-03-15_16-02)
...
- [ ] Create `example/user/` directory structure with `commands.go`, `queries.go`, `events.go`, `handlers.go` (source: 2026-03-15_16-02)
- [ ] Create `example/main.go` working example (source: 2026-03-15_16-02)
...
- [ ] Add `AddCommandFromType[T]()` generic helpers (source: 2026-04-10_12-14)
...
- [ ] Add `middleware/logging.go` and `middleware/recovery.go` implementations (source: 2026-04-02_22-58)
- [ ] Create pre-built retry middleware with backoff (source: 2026-03-30_20-34)
...
- [ ] Create `Makefile` with build/test/lint targets (source: 2026-03-15_16-02)
- [ ] Archive old status reports (keep 3 most recent) (source: 2026-04-11_20-54)
- [ ] Remove unused `Dispatcher.Dispatch` `_ H` parameter (source: 2026-04-02_23-02)
...
- [ ] Add `middleware/metrics.go` metrics collection middleware (source: 2026-04-02_22-58, 2026-03-30_20-34)
...
- [ ] Generate `llms.txt` alongside EventCatalog output (source: 2026-04-10_12-14)
