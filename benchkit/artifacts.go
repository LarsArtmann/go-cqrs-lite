...
func WriteBenchstat(w io.Writer, r *Result) {
	...
	lines := []struct {
		...
		{"metaengine_sqlite_scan_p99_ns", float64(r.MetaEngineSQLiteScanLatency.P99.Nanoseconds()), "ns/op"},
		{"metaengine_sqlite_point_read_p99_ns", float64(r.MetaEngineSQLitePointReadLatency.P99.Nanoseconds()), "ns/op"},
